...
$segment  = 5;
$url      = 'peraturan/search/rows/'.$this->uri->segment(4).'/';
}else{
$per_page = 25;
$segment  = 3;
$url      = 'peraturan/search';
}
?>
...
<?php foreach(core::get_search_pagination('ac_peraturan','ancient',$this->input->get('search'),$this->input->get('search_by'),$per_page,$url)->result() as $row): { ?><tr>
<td><?php echo $i;?></td>
