...
class Peraturan extends Core
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('peraturan_model','model');
    }
    ...
    function create()
    {
        ...
        {
            core::insert('ac_peraturan','ancient',array(
    ...
    function update($id = '')
    {
        ...
        {
            core::update('ac_peraturan','ancient',array(
				'title' => $this->input->post('title'),
				'content' => $this->input->post('content'),
				'created' => date('Y-m-d H:i:s')
				),$this->input->post('id'));
    ...
    function delete($id = '')
    {
        core::delete('ac_peraturan','ancient',$id);
        redirect('peraturan');
    }
