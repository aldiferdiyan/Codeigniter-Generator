...
<?php echo $this->load->view('_layouts/menus');?>   
    ...
    <!--START FORM-->
    <form method='POST' charset='UTF-8' action='<?php echo base_url('member/update').'/'.$this->uri->segment(3);?>' class="form form-horizontal" >
        
       <?php $query = core::get_where('mb_member','member',array('id' => $this->uri->segment(3)),1); ?>
...
<div class='controls'>
<input type='text' name='password' class='span5' value='<?php echo $row['password'];?>' placeholder='password' required>
...
<div class='controls'>
<input type='text' name='email' class='span5' value='<?php echo $row['email'];?>' placeholder='email' required>
...
<div class='controls'>
<input type='text' name='no_telepon' class='span5' value='<?php echo $row['no_telepon'];?>' placeholder='no telepon' required>
...
<div class='controls'>
<textarea name='description' class='span10'  placeholder='description' required><?php echo $row['description'];?><?php echo set_value('description');?></textarea>
