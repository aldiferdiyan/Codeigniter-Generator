...
<form action='<?php echo base_url('konfirmasi_reseller/search');?>' method='get'>
...
<option value="<?php echo base_url('konfirmasi_reseller/index/rows/25');?>">25 Rows</option>
<option value="<?php echo base_url('konfirmasi_reseller/index/rows/50');?>">50 Rows</option>
<option value="<?php echo base_url('konfirmasi_reseller/index/rows/75');?>">75 Rows</option>
<option value="<?php echo base_url('konfirmasi_reseller/index/rows/100');?>">100 Rows</option>
<option value="<?php echo base_url('konfirmasi_reseller/index/rows/200');?>">200 Rows</option>
</select>
...
$segment  = 5;
$url      = 'konfirmasi_reseller/index/rows/'.$this->uri->segment(4).'/';
}else{
$per_page = 25;
$segment  = 3;
$url      = 'konfirmasi_reseller/index';
}
?>
...
<?php $num_rows = core::get_all('rs_konfirmasi','reseller')->num_rows();?>
...
<?php foreach(core::get_all_pagination('rs_konfirmasi','reseller',$per_page,$segment,$url)->result() as $row): { ?><tr>
<td><?php echo $i;?></td>
