...
<?php echo $this->load->view('_layouts/menus');?>   
    ...
    <!--START FORM-->
    <form method='POST' charset='UTF-8' action='<?php echo base_url('berita/create');?>' class="form" >
        
       <!-- start title -->
<div class='control-group <?php echo form_error('title') ? 'error' : ''; ?>'>
<label class='control-label' ><strong>Title</strong></label>
<div class='controls'>
<input type='text' name='title' value='<?php echo set_value('title');?>' class='span9' placeholder='title' required>
...
<div class='controls'>
<textarea name='intro_content' id='intro_content' class='span10' placeholder='intro content'><?php echo set_value('intro_content');?></textarea>
...
<div class='controls'>
<textarea name='content' id='content' class='span10' placeholder='content'><?php echo set_value('content');?></textarea>
...
<div id="datetimepicker" class="input-append date">
    <input name='created' data-format="yyyy-MM-dd hh:mm:ss" value='<?php echo date("Y-m-d H:i:s");?>' type="text" readonly>
    <span class="add-on">
...
<div class='controls'>
<input type='text' name='created_alias' value='<?php echo set_value('created_alias') == TRUE ? set_value('created_alias') : $this->session->userdata('admin_username');?>' class='span5' placeholder='created alias' required>
...
<div class='controls'>
<input type='text' name='meta_key' value='<?php echo set_value('meta_key');?>' class='span5' placeholder='meta key'>
...
<div class='controls'>
<textarea name='meta_desc' rows='4' class='span10' placeholder='meta desc'><?php echo set_value('meta_desc');?></textarea>
