...
<option value="<?php echo base_url('berita/index/rows/25');?>">25 Rows</option>
<option value="<?php echo base_url('berita/index/rows/50');?>">50 Rows</option>
<option value="<?php echo base_url('berita/index/rows/75');?>">75 Rows</option>
<option value="<?php echo base_url('berita/index/rows/100');?>">100 Rows</option>
<option value="<?php echo base_url('berita/index/rows/200');?>">200 Rows</option>
</select>
...
$segment  = 5;
$url      = 'berita/index/rows/'.$this->uri->segment(4).'/';
}else{
$per_page = 25;
$segment  = 3;
$url      = 'berita/index';
