...
<?php echo $this->load->view('_layouts/menus');?>   
    ...
    <!--START FORM-->
    <form method='POST' charset='UTF-8' action='<?php echo base_url('menus/update').'/'.$this->uri->segment(3);?>' class="form form-horizontal" >
        
       <?php $query = core::get_where('ac_menus','ancient',array('id' => $this->uri->segment(3)),1); ?>
...
<div class="controls">
<a href='<?php echo base_url('menus');?>' class="btn"><i class='fa fa-times'></i> Cancel</a>
