...
<?php $num_rows = core::get_search('ac_admin','ancient',$this->input->get('search'),$this->input->get('search_by'))->num_rows();?>
...
<?php foreach(core::get_search_pagination('ac_admin','ancient',$this->input->get('search'),$this->input->get('search_by'),$per_page,$url)->result() as $row): { ?><tr>
<td><?php echo $i;?></td>
			<td><?php echo $row->username ;?></td>
			<td><?php echo $row->email ;?></td>
			<td><?php echo $row->status == '1' ? "Super Admin" : "User";?></td>
			<td>
		    <center><div class='btn-group' >
		    <a href='<?php echo base_url();?>admin/delete/<?php echo $row->id;?>' class='btn btn-small' data-confirm='Delete this data?'><i class='text-error fa fa-trash-o'></i></a>
                    <a href='<?php echo base_url();?>admin/detail/<?php echo $row->id;?>' class='btn btn-small'><i class='text-info fa fa-weibo'></i></a>
                    </div></center>
                    </td>
