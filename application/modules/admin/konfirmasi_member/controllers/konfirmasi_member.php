...
class Konfirmasi_member extends Admincore
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('konfirmasi_member_model','model');
    }
    ...
    function update($id = '')
    {
        ...
        {
            core::update('mb_konfirmasi','member',array(
				'order_code' => $this->input->post('order_code'),
				'atas_nama' => $this->input->post('atas_nama'),
				'bank' => $this->input->post('bank'),
				'jumlah_transfer' => $this->input->post('jumlah_transfer'),
    ...
    function delete($id = '')
    {
        core::delete('mb_konfirmasi','member',$id);
        redirect('konfirmasi_member');
    }
