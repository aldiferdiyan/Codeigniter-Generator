...
<?php echo $this->load->view('_layouts/menus');?>   
    ...
    <!--START FORM-->
    <form method='POST' charset='UTF-8' action='<?php echo base_url('konfirmasi_member/update').'/'.$this->uri->segment(3);?>' class="form form-horizontal" >
        
       <?php $query = core::get_where('mb_konfirmasi','member',array('id' => $this->uri->segment(3)),1); ?>
...
<div class="controls">
<a href='<?php echo base_url('konfirmasi_member');?>' class="btn"><i class='fa fa-times'></i> Cancel</a>
