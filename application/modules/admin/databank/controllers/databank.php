...
class Databank extends Admincore
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('databank_model','model');
    }
    ...
    function create()
    {
        ...
        {
            core::insert('ac_databank','ancient',array(
    ...
    function update($id = '')
    {
        ...
        {
            core::update('ac_databank','ancient',array(
				'bank' => $this->input->post('bank'),
				'atas_nama' => $this->input->post('atas_nama'),
				'no_rek' => $this->input->post('no_rek'),
				'cabang' => $this->input->post('cabang'),
    ...
    function delete($id = '')
    {
        core::delete('ac_databank','ancient',$id);
        redirect('databank');
    }
